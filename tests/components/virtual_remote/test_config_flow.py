...
from homeassistant.components.virtual_remote.config_flow import (
    CONF_CREATE_BUTTON,
...
from homeassistant.components.virtual_remote.infrared_library import (
...
def _direct_flow(hass: HomeAssistant) -> VirtualRemoteConfigFlow:
...
def _prepared_flow(hass: HomeAssistant) -> VirtualRemoteConfigFlow:
...
async def test_user_flow_tv_device_type_shows_codeset_step(
    ...
    with (
        ...
        patch(
            "homeassistant.components.virtual_remote.config_flow."
