"""Button entities for Virtual Remote commands."""
...
class VirtualRemoteButtonEntityDescription(ButtonEntityDescription):
    """Description of a Virtual Remote command button."""
...
async def async_setup_entry(
    ...
    """Set up Virtual Remote buttons from a config entry."""
    entities: list[VirtualRemoteButton] = []
    expected_unique_ids: set[str] = set()

    for remote in virtual_remotes_from_config_entry(entry):
        ...
        for command_name, command in commands.items():
            ...
            entities.append(
                VirtualRemoteButton(
                    ...
                    unique_id=unique_id,
                    description=VirtualRemoteButtonEntityDescription(
...
class VirtualRemoteButton(ButtonEntity):
    """A button which sends a configured Virtual Remote command."""

    entity_description: VirtualRemoteButtonEntityDescription
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize a Virtual Remote button."""
