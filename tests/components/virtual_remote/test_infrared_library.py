"""Tests for the Virtual Remote infrared library helpers."""
...
def test_infrared_library_codeset_available_handles_load_errors() -> None:
    ...
    with patch(
        "homeassistant.components.virtual_remote.infrared_library."
        "_load_infrared_library_enum",
...
def test_load_infrared_library_enum_success() -> None:
    ...
    with (
        ...
        patch(
            "homeassistant.components.virtual_remote.infrared_library.import_module",
            return_value=module,
        ),
    ):
...
def test_load_infrared_library_enum_errors() -> None:
    ...
    with (
        ...
        patch(
            "homeassistant.components.virtual_remote.infrared_library.getattr",
            return_value=object(),
        ),
        pytest.raises(InfraredLibraryCommandError),
    ):
