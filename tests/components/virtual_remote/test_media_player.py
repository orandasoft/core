"""Tests for Virtual Remote media player entities."""
...
from homeassistant.components.virtual_remote.media_player import (
...
def _media_player_entity(
    ...
    entity = VirtualRemoteTvMediaPlayer(
        remote_id=REMOTE_ID,
...
def _media_player_entity_without_hass(
    ...
    return VirtualRemoteTvMediaPlayer(
        remote_id=REMOTE_ID,
        remote_name=REMOTE_NAME,
        infrared_entity_id=infrared_entity,
...
async def test_async_setup_entry_adds_tv_media_player(
    ...
    """Test setup creates a media player for TV virtual remotes."""
...
async def test_media_player_commands_send_infrared_command(
    ...
    with patch(
        "homeassistant.components.virtual_remote.media_player."
