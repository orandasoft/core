"""Media player entities for Virtual Remote devices."""
...
def media_player_unique_id(entry_id: str, remote_id: str) -> str:
    """Return the unique id for a virtual remote media player."""
...
def cleanup_stale_media_player_entities(
    ...
    """Remove stale Virtual Remote media player entity registry entries."""
...
async def async_setup_entry(
    ...
    """Set up Virtual Remote media players from a config entry."""
    entities: list[VirtualRemoteTvMediaPlayer] = []
...
class VirtualRemoteTvMediaPlayer(MediaPlayerEntity):
    """Assumed-state TV media player backed by Virtual Remote commands."""
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize the Virtual Remote TV media player."""
